---
title: "Visa photo requirements — US, UK, Schengen explained"
slug: "visa-photo-requirements-us-uk-schengen"
category: "visa-specs"
...
The US is the most rule-bound of the three. State Department spec ([travel.state.gov](https://travel.state.gov)) is unambiguous: 600 × 600 pixels, square, head height **50 to 69%** of the frame, plain white or off-white background, taken within the last 6 months.

**Three things that surprise applicants:**

1. **No glasses** — period. Not even prescription. This rule changed in November 2016 and is enforced by automated screening.
2. **The same photo can't be reused** if it was used on a previous US visa within the past 6 months. The State Department flags duplicates.
3. **The aspect must be exactly 1:1.** A 600 × 800 photo will be rejected even though both dimensions are within range, because the ratio is wrong.
...
1. ✅ Open the photo on your phone. Does the face look symmetrical? Centered? In focus?
2. ✅ Background plain? No curtains, walls with patterns, off-coloured tints?
3. ✅ Eyes wide open, looking at the camera, neutral expression?
4. ✅ No glasses (US, sometimes others)?
5. ✅ Recent — taken in the last 1–6 months?

If anything is off, retake. A failed visa application is far more costly than 5 minutes of redoing a photo.

## See also

- [US Visa Photo Size](/us-visa-photo-size) — preset + tool
- [UK Visa Photo Size](/uk-visa-photo-size) — preset + tool
- [Schengen Visa Photo Size](/schengen-visa-photo-size) — preset + tool
- [Photo & Signature resizer](/photo-signature) — picker UI
- [Why your form rejected your photo](/blog/why-your-form-rejected-your-photo) — broader rejection-reason guide
