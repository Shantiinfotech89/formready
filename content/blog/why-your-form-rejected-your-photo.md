---
title: "Why your form rejected your photo (and how to fix it)"
slug: "why-your-form-rejected-your-photo"
category: "how-to"
...
**Fix:** retake with the correct framing in mind, or use a crop tool to set the right aspect first. Our [crop & rotate tool](/crop-rotate) has presets for passport, square, and standard ratios.
...
- [Photo & Signature resizer](/photo-signature) — for SSC, UPSC, NEET, IBPS, JEE, and 8 visa types
- [Image compression](/compress-image) — for any custom KB target
- [Crop & rotate](/crop-rotate) — to fix framing before compression
- [SSC CGL photo size guide](/ssc-cgl-photo-size)
- [US visa photo size guide](/us-visa-photo-size)
